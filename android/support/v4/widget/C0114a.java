...
final class C0114a implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (f320b.length - 1)) * f), f320b.length - 2);
        float f2 = (f - (((float) min) * f321c)) / f321c;
        return ((f320b[min + 1] - f320b[min]) * f2) + f320b[min];
    }
}
