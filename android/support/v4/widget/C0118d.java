...
public abstract class C0118d extends BaseAdapter implements C0117h, Filterable {
    @Deprecated
    public static final int FLAG_AUTO_REQUERY = 1;
    public static final int FLAG_REGISTER_CONTENT_OBSERVER = 2;
    protected boolean mAutoRequery;
    protected C0119e mChangeObserver;
    protected Context mContext;
    protected Cursor mCursor;
    protected C0121g mCursorFilter;
    ...
    @Deprecated
    public C0118d(Context context, Cursor cursor) {
        init(context, cursor, (int) FLAG_AUTO_REQUERY);
    }

    public C0118d(Context context, Cursor cursor, int i) {
        init(context, cursor, i);
    }

    public C0118d(Context context, Cursor cursor, boolean z) {
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new C0121g(this);
        }
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        if ((i & FLAG_REGISTER_CONTENT_OBSERVER) == FLAG_REGISTER_CONTENT_OBSERVER) {
            this.mChangeObserver = new C0119e(this);
            this.mDataSetObserver = new C0120f();
        } else {
