...
public class FragmentActivity extends Activity {
    ...
    public FragmentActivity() {
        this.mHandler = new C00101();
        this.mFragments = new FragmentManagerImpl();
        this.mContainer = new C00112();
    }
    ...
    LoaderManagerImpl getLoaderManager(String str, boolean z, boolean z2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = new C0028m();
        }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i3 = size - 1; i3 >= 0; i3--) {
                loaderManagerImplArr[i3] = (LoaderManagerImpl) this.mAllLoaderManagers.m9c(i3);
            }
            i2 = 0;
            while (i < size) {
    ...
    protected void onStart() {
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                loaderManagerImplArr[i] = (LoaderManagerImpl) this.mAllLoaderManagers.m9c(i);
            }
