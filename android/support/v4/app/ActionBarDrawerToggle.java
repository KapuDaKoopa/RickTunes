...
public class ActionBarDrawerToggle implements C0005k {
    ...
    class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int i2 = an.m375f(this.this$0.mActivity.getWindow().getDecorView()) == 1 ? 1 : 0;
            if (i2 != 0) {
                i = -1;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.m582d()) {
            this.mDrawerLayout.m579b();
        } else {
            this.mDrawerLayout.m574a();
        }
        return true;
    }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.m581c() ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
            } else {
