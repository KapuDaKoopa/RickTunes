...
final class FragmentManagerImpl extends FragmentManager {
    ...
    class C00154 implements Runnable {
        final /* synthetic */ int val$flags;
    ...
    class C00165 implements AnimationListener {
        final /* synthetic */ Fragment val$fragment;

        C00165(Fragment fragment) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    final void moveToState(android.support.v4.app.Fragment r10, int r11, int r12, int r13, boolean r14) {
        /*
        r9 = this;
        r8 = 4;
        r6 = 3;
    ...
    public final void popBackStack(int i, int i2) {
        ...
        enqueueAction(new C00154(i, i2), HONEYCOMB);
    }

    public final void popBackStack(String str, int i) {
        enqueueAction(new C00143(str, i), HONEYCOMB);
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    final boolean popBackStackState(android.os.Handler r8, java.lang.String r9, int r10, int r11) {
        /*
        r7 = this;
        r2 = 1;
        r3 = 0;
    ...
    public final String toString() {
        ...
        if (this.mParent != null) {
            C0033d.m36a(this.mParent, stringBuilder);
        } else {
