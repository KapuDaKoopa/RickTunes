...
import android.support.v4.widget.C0118d;
...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    private C0118d mSuggestionsAdapter;
    ...
    class C01894 implements OnFocusChangeListener {
        C01894() {
        }
    ...
    class C01905 implements OnLayoutChangeListener {
        C01905() {
        }
    ...
    class C01916 implements OnGlobalLayoutListener {
        C01916() {
        }
    ...
    class C01927 implements OnClickListener {
        C01927() {
        }
    ...
    class C01938 implements OnKeyListener {
        C01938() {
        }
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            ...
            if (SearchView.this.mQueryTextView.isEmpty() || !C0105r.m519b(keyEvent)) {
                return SearchView.DBG;
            }
    ...
    class C01949 implements OnEditorActionListener {
        C01949() {
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mShowImeRunnable = new C01861();
        this.mUpdateDrawableStateRunnable = new C01872();
        this.mReleaseCursorRunnable = new C01883();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01927();
        this.mTextKeyListener = new C01938();
        this.mOnEditorActionListener = new C01949();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0152R.layout.abs__search_view, this, true);
        this.mSearchButton = findViewById(C0152R.id.abs__search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0152R.id.abs__search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0152R.id.abs__search_edit_frame);
        this.mSearchPlate = findViewById(C0152R.id.abs__search_plate);
        this.mSubmitArea = findViewById(C0152R.id.abs__submit_area);
        this.mSubmitButton = findViewById(C0152R.id.abs__search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0152R.id.abs__search_close_btn);
        this.mVoiceButton = findViewById(C0152R.id.abs__search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0152R.id.abs__search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C01894());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockSearchView, 0, 0);
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockSearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0152R.styleable.SherlockSearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        CharSequence text = obtainStyledAttributes.getText(C0152R.styleable.SherlockSearchView_queryHint);
        if (!TextUtils.isEmpty(text)) {
            setQueryHint(text);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0152R.styleable.SherlockSearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0152R.styleable.SherlockSearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        obtainStyledAttributes.recycle();
        obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockView, 0, 0);
        boolean z = obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockView_android_focusable, true);
        obtainStyledAttributes.recycle();
        setFocusable(z);
        ...
        if (this.mDropDownAnchor != null) {
            if (VERSION.SDK_INT >= 11) {
                this.mDropDownAnchor.addOnLayoutChangeListener(new C01905());
            } else {
                this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01916());
            }
        }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(C0152R.dimen.abs__dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0152R.dimen.abs__dropdownitem_icon_width);
            } else {
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0152R.dimen.abs__search_view_preferred_width);
    }

    private int getSearchIconId() {
        TypedValue typedValue = new TypedValue();
        getContext().getTheme().resolveAttribute(C0152R.attr.searchViewSearchIcon, typedValue, true);
    ...
    private boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable == null || this.mSuggestionsAdapter == null || keyEvent.getAction() != 0 || !C0105r.m519b(keyEvent)) {
            return DBG;
        }
        if (i == 66 || i == 84 || i == 61) {
    ...
    public C0118d getSuggestionsAdapter() {
    ...
    public void setSuggestionsAdapter(C0118d c0118d) {
        this.mSuggestionsAdapter = c0118d;
        this.mQueryTextView.setAdapter(this.mSuggestionsAdapter);
    }
}
