...
class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    /* renamed from: com.actionbarsherlock.widget.ActivityChooserView.1 */
    class C01831 extends DataSetObserver {
        C01831() {
        }
    ...
    /* renamed from: com.actionbarsherlock.widget.ActivityChooserView.2 */
    class C01842 implements OnGlobalLayoutListener {
        C01842() {
        }
    ...
    /* renamed from: com.actionbarsherlock.widget.ActivityChooserView.3 */
    class C01853 extends DataSetObserver {
        C01853() {
        }
            ...
            switch (getItemViewType(i)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (view == null || view.getId() != C0152R.id.abs__list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0152R.layout.abs__activity_chooser_view_list_item, viewGroup, false);
                    }
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    ...
                    ((TextView) view.findViewById(C0152R.id.abs__title)).setText(ActivityChooserView.this.mContext.getString(C0152R.string.abs__activity_chooser_view_see_all));
                    return view;
                default:
                    throw new IllegalArgumentException();
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new C01831();
        this.mOnGlobalLayoutListener = new C01842();
        ...
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0152R.styleable.SherlockActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(this.mContext).inflate(C0152R.layout.abs__activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (IcsLinearLayout) findViewById(C0152R.id.abs__activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0152R.id.abs__default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0152R.id.abs__image);
        this.mExpandActivityOverflowButton = (FrameLayout) findViewById(C0152R.id.abs__expand_activities_button);
        this.mExpandActivityOverflowButton.setOnClickListener(this.mCallbacks);
        this.mExpandActivityOverflowButtonImage = (ImageView) this.mExpandActivityOverflowButton.findViewById(C0152R.id.abs__image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(drawable);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C01853());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0152R.dimen.abs__config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int i) {
        ...
        if (!listPopupWindow.isShowing()) {
            ...
            listPopupWindow.getListView().setContentDescription(this.mContext.getString(C0152R.string.abs__activitychooserview_choose_application));
        }
    }
