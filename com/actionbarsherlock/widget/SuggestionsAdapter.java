...
import android.support.v4.widget.C0131s;
...
class SuggestionsAdapter extends C0131s implements OnClickListener {
    ...
    final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0152R.id.edit_query);
        }
    }

    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap weakHashMap) {
        super(context, C0152R.layout.abs__search_dropdown_item_icons_2line, null, true);
        this.mClosed = DBG;
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0152R.attr.textColorSearchUrl, typedValue, true);
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        try {
            Cursor suggestions = getSuggestions(obj, QUERY_LIMIT);
            if (suggestions != null) {
