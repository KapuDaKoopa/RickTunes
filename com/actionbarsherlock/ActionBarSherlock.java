...
public abstract class ActionBarSherlock {
    ...
    public ActionBarSherlock(Activity activity, int i) {
        ...
        this.mIsDelegate = (i & FLAG_DELEGATE) != 0 ? true : DEBUG;
    }
    ...
    public static ActionBarSherlock wrap(Activity activity, int i) {
        ...
        obj = null;
        if (obj != null) {
            Object obj2 = activity.getResources().getDisplayMetrics().densityDpi == 213 ? FLAG_DELEGATE : null;
