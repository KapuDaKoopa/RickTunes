...
public class ActionBarSherlockCompat extends ActionBarSherlock implements OnMenuItemClickListener, Callback, MenuPresenter.Callback, Window.Callback {
    ...
    private ViewGroup generateLayout() {
        TypedArray obtainStyledAttributes = this.mActivity.getTheme().obtainStyledAttributes(C0152R.styleable.SherlockTheme);
        this.mIsFloating = obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockTheme_android_windowIsFloating, false);
        if (obtainStyledAttributes.hasValue(C0152R.styleable.SherlockTheme_windowActionBar)) {
            int i;
            if (obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockTheme_windowNoTitle, false)) {
                requestFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockTheme_windowActionBar, false)) {
                requestFeature(8);
            }
            if (obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockTheme_windowActionBarOverlay, false)) {
                requestFeature(9);
            }
            if (obtainStyledAttributes.getBoolean(C0152R.styleable.SherlockTheme_windowActionModeOverlay, false)) {
                requestFeature(10);
            }
            obtainStyledAttributes.recycle();
            if (hasFeature(1)) {
                i = (!hasFeature(10) || hasFeature(1)) ? C0152R.layout.abs__screen_simple : C0152R.layout.abs__screen_simple_overlay_action_mode;
            } else if (this.mIsFloating) {
                this.mDecor = (ViewGroup) this.mDecor.getParent();
                this.mDecor.removeAllViews();
                i = C0152R.layout.abs__dialog_title_holo;
            } else {
                i = hasFeature(9) ? C0152R.layout.abs__screen_action_bar_overlay : C0152R.layout.abs__screen_action_bar;
            }
            this.mDecor.addView(this.mActivity.getLayoutInflater().inflate(i, null), new LayoutParams(-1, -1));
            ViewGroup viewGroup = (ViewGroup) this.mDecor.findViewById(C0152R.id.abs__content);
            if (viewGroup == null) {
    ...
    private IcsProgressBar getCircularProgressBar(boolean z) {
        ...
        this.mCircularProgressBar = (IcsProgressBar) this.mDecor.findViewById(C0152R.id.abs__progress_circular);
        if (this.mCircularProgressBar != null) {
    ...
    private IcsProgressBar getHorizontalProgressBar(boolean z) {
        ...
        this.mHorizontalProgressBar = (IcsProgressBar) this.mDecor.findViewById(C0152R.id.abs__progress_horizontal);
        if (this.mHorizontalProgressBar != null) {
    ...
    private boolean initializePanelMenu() {
        ...
        if (this.wActionBar != null) {
            ...
            context.getTheme().resolveAttribute(C0152R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    private void installDecor() {
        ...
        if (this.mContentParent == null) {
            ...
            if (this.mTitleView == null) {
                this.wActionBar = (ActionBarView) this.mDecor.findViewById(C0152R.id.abs__action_bar);
                if (this.wActionBar != null) {
                    ...
                    boolean resources_getBoolean = z ? ResourcesCompat.getResources_getBoolean(this.mActivity, C0152R.bool.abs__split_action_bar_is_narrow) : this.mActivity.getTheme().obtainStyledAttributes(C0152R.styleable.SherlockTheme).getBoolean(C0152R.styleable.SherlockTheme_windowSplitActionBar, false);
                    ActionBarContainer actionBarContainer = (ActionBarContainer) this.mDecor.findViewById(C0152R.id.abs__split_action_bar);
                    if (actionBarContainer != null) {
                        ...
                        this.mActionModeView = (ActionBarContextView) this.mDecor.findViewById(C0152R.id.abs__action_context_bar);
                    ...
                    try {
                        ...
                        for (eventType = openXmlResourceParser.getAttributeCount() - 1; eventType >= 0; eventType--) {
                            if ("uiOptions".equals(openXmlResourceParser.getAttributeName(eventType))) {
                                eventType = openXmlResourceParser.getAttributeIntValue(eventType, DEFAULT_FEATURES);
                                break;
                            }
                        }
                        eventType = i;
    ...
    public void setProgress(int i) {
        updateInt(2, i + DEFAULT_FEATURES, false);
    }
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        ...
        if (startActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                ViewStub viewStub = (ViewStub) this.mDecor.findViewById(C0152R.id.abs__action_mode_bar_stub);
                if (viewStub != null) {
