...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    class SavedState implements Parcelable {
        ...
        final class C01641 implements Creator {
            C01641() {
            }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0152R.layout.abs__action_menu_layout, C0152R.layout.abs__action_menu_item_layout);
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(context, C0152R.integer.abs__max_action_buttons);
        }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(this.mContext, C0152R.integer.abs__max_action_buttons);
            if (this.mMenu != null) {
