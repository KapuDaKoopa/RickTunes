...
public class ActionMenuItemView extends LinearLayout implements OnClickListener, OnLongClickListener, View_HasStateListenerSupport, ActionMenuChildView, ItemView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAllowTextWithIcon = ResourcesCompat.getResources_getBoolean(context, C0152R.bool.abs__config_allowActionMenuItemTextWithIcon);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockActionMenuItemView, 0, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0152R.styleable.SherlockActionMenuItemView_android_minWidth, 0);
    ...
    public void onFinishInflate() {
        this.mImageButton = (ImageButton) findViewById(C0152R.id.abs__imageButton);
        this.mTextButton = (CapitalizingButton) findViewById(C0152R.id.abs__textButton);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        size = mode == GridLayout.UNDEFINED ? Math.min(size, this.mMinWidth) : this.mMinWidth;
