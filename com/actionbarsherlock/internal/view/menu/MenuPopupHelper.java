...
public class MenuPopupHelper implements OnKeyListener, OnGlobalLayoutListener, OnItemClickListener, OnDismissListener, View_OnAttachStateChangeListener, MenuPresenter {
    ...
    static {
        ITEM_LAYOUT = C0152R.layout.abs__popup_menu_item_layout;
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0152R.dimen.abs__config_prefDialogWidth));
    ...
    public boolean tryShow() {
        boolean z = false;
        this.mPopup = new IcsListPopupWindow(this.mContext, null, C0152R.attr.popupMenuStyle);
