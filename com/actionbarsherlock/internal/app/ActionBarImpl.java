...
public class ActionBarImpl extends ActionBar {
    ...
    class C01541 extends AnimatorListenerAdapter {
        C01541() {
        }
    ...
    class C01552 extends AnimatorListenerAdapter {
        C01552() {
        }
    ...
    public ActionBarImpl(Activity activity, int i) {
        ...
        this.mHideListener = new C01541();
        this.mShowListener = new C01552();
    ...
    private void init(View view) {
        ...
        this.mActionView = (ActionBarView) view.findViewById(C0152R.id.abs__action_bar);
        this.mContextView = (ActionBarContextView) view.findViewById(C0152R.id.abs__action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0152R.id.abs__action_bar_container);
        this.mSplitView = (ActionBarContainer) view.findViewById(C0152R.id.abs__split_action_bar);
        ...
        setHasEmbeddedTabs(ResourcesCompat.getResources_getBoolean(this.mContext, C0152R.bool.abs__action_bar_embed_tabs));
    }
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0152R.attr.actionBarWidgetTheme, typedValue, true);
