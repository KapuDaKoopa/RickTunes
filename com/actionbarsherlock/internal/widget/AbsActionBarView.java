...
public abstract class AbsActionBarView extends NineViewGroup {
    ...
    protected int measureChildView(View view, int i, int i2, int i3) {
        view.measure(MeasureSpec.makeMeasureSpec(i, GridLayout.UNDEFINED), i2);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.mSplitWhenNarrow) {
            setSplitActionBar(ResourcesCompat.getResources_getBoolean(getContext(), C0152R.bool.abs__split_action_bar_is_narrow));
        }
        if (this.mActionMenuPresenter != null) {
