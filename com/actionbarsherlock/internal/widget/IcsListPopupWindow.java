...
public class IcsListPopupWindow {
    ...
    class C01761 implements OnItemSelectedListener {
        C01761() {
        }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01761());
            ...
            if (view2 != null) {
                ...
                view2.measure(MeasureSpec.makeMeasureSpec(this.mDropDownWidth, GridLayout.UNDEFINED), POSITION_PROMPT_ABOVE);
