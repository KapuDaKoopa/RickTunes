...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
    ...
    class DropdownPopup extends IcsListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int i) {
            ...
            setModal(true);
            setPromptPosition(0);
            setOnItemClickListener(new C01791(IcsSpinner.this));
        }
    ...
    public IcsSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0152R.attr.actionDropDownStyle);
    }

    public IcsSpinner(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mTempRect = new Rect();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockSpinner, i, 0);
        SpinnerPopup dropdownPopup = new DropdownPopup(context, attributeSet, i);
        this.mDropDownWidth = obtainStyledAttributes.getLayoutDimension(C0152R.styleable.SherlockSpinner_android_dropDownWidth, -2);
        dropdownPopup.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockSpinner_android_popupBackground));
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0152R.styleable.SherlockSpinner_android_dropDownVerticalOffset, 0);
        if (dimensionPixelOffset != 0) {
            dropdownPopup.setVerticalOffset(dimensionPixelOffset);
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0152R.styleable.SherlockSpinner_android_dropDownHorizontalOffset, 0);
        if (dimensionPixelOffset != 0) {
            dropdownPopup.setHorizontalOffset(dimensionPixelOffset);
        }
        this.mPopup = dropdownPopup;
        this.mGravity = obtainStyledAttributes.getInt(C0152R.styleable.SherlockSpinner_android_gravity, 17);
        this.mPopup.setPromptText(obtainStyledAttributes.getString(C0152R.styleable.SherlockSpinner_android_prompt));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mPopup != null && MeasureSpec.getMode(i) == GridLayout.UNDEFINED) {
    ...
    public void setEnabled(boolean z) {
        ...
        if (this.mDisableChildrenWhenDisabled) {
            ...
            for (int i = 0; i < childCount; i += MODE_DROPDOWN) {
