...
public class ActionBarView extends AbsActionBarView {
    ...
    class C01691 implements OnItemSelectedListener {
        C01691() {
        }
    ...
    class C01702 implements OnClickListener {
        C01702() {
        }
    ...
    public class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            this.mUpView = findViewById(C0152R.id.abs__up);
            this.mIconView = (ImageView) findViewById(C0152R.id.abs__home);
        }
    ...
    class SavedState extends BaseSavedState {
        ...
        final class C01721 implements Creator {
            C01721() {
            }
    ...
    public ActionBarView(Context context, AttributeSet attributeSet) {
        ...
        this.mNavItemSelectedListener = new C01691();
        this.mExpandedActionViewUpListener = new C01702();
        this.mUpClickListener = new C01713();
        setBackgroundResource(DISPLAY_DEFAULT);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockActionBar, C0152R.attr.actionBarStyle, DISPLAY_DEFAULT);
        ApplicationInfo applicationInfo = context.getApplicationInfo();
        PackageManager packageManager = context.getPackageManager();
        this.mNavigationMode = obtainStyledAttributes.getInt(C0152R.styleable.SherlockActionBar_navigationMode, DISPLAY_DEFAULT);
        this.mTitle = obtainStyledAttributes.getText(C0152R.styleable.SherlockActionBar_title);
        this.mSubtitle = obtainStyledAttributes.getText(C0152R.styleable.SherlockActionBar_subtitle);
        this.mLogo = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionBar_logo);
        if (this.mLogo == null) {
        ...
        this.mIcon = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionBar_icon);
        if (this.mIcon == null) {
            if (context instanceof Activity) {
                try {
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionBar_homeLayout, C0152R.layout.abs__action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0152R.string.abs__action_bar_up_description));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionBar_titleTextStyle, DISPLAY_DEFAULT);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionBar_subtitleTextStyle, DISPLAY_DEFAULT);
        this.mProgressStyle = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionBar_progressBarStyle, DISPLAY_DEFAULT);
        this.mIndeterminateProgressStyle = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionBar_indeterminateProgressStyle, DISPLAY_DEFAULT);
        this.mProgressBarPadding = obtainStyledAttributes.getDimensionPixelOffset(C0152R.styleable.SherlockActionBar_progressBarPadding, DISPLAY_DEFAULT);
        this.mItemPadding = obtainStyledAttributes.getDimensionPixelOffset(C0152R.styleable.SherlockActionBar_itemPadding, DISPLAY_DEFAULT);
        setDisplayOptions(obtainStyledAttributes.getInt(C0152R.styleable.SherlockActionBar_displayOptions, DISPLAY_DEFAULT));
        loadLogoFromManifest = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionBar_customNavigationLayout, DISPLAY_DEFAULT);
        if (loadLogoFromManifest != 0) {
        ...
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(C0152R.styleable.SherlockActionBar_height, DISPLAY_DEFAULT);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0152R.layout.abs__action_bar_title_item, this, DEBUG);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0152R.id.abs__action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0152R.id.abs__action_bar_subtitle);
            this.mTitleUpView = this.mTitleLayout.findViewById(C0152R.id.abs__up);
    ...
    private static int loadLogoFromManifest(Activity activity) {
        ...
        try {
            ...
            XmlResourceParser openXmlResourceParser = activity.createPackageContext(str, DISPLAY_DEFAULT).getAssets().openXmlResourceParser("AndroidManifest.xml");
                    ...
                    try {
                            ...
                            if ("activity".equals(name2)) {
                                ...
                                for (eventType = openXmlResourceParser.getAttributeCount() - 1; eventType >= 0; eventType--) {
                                    ...
                                    if (!"logo".equals(attributeName)) {
                                        ...
                                        num = Integer.valueOf(openXmlResourceParser.getAttributeResourceValue(eventType, DISPLAY_DEFAULT));
                                    }
                                    if (!(num == null || r4 == null)) {
                                        i = num.intValue();
                                    }
                        ...
                        for (eventType = openXmlResourceParser.getAttributeCount() - 1; eventType >= 0; eventType--) {
                            if ("logo".equals(openXmlResourceParser.getAttributeName(eventType))) {
                                eventType = openXmlResourceParser.getAttributeResourceValue(eventType, DISPLAY_DEFAULT);
                                break;
                            }
                        }
                        eventType = i;
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0152R.id.abs__progress_circular);
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0152R.id.abs__progress_horizontal);
    ...
    public void setDisplayOptions(int i) {
        ...
        if (!this.mHomeLayout.isEnabled()) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0152R.string.abs__action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0152R.string.abs__action_bar_home_description));
        }
    }
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback callback) {
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0152R.id.abs__action_menu_presenter);
            ...
            if (this.mSplitActionBar) {
                ...
                this.mActionMenuPresenter.setExpandedActionViewsExclusive(ResourcesCompat.getResources_getBoolean(getContext(), C0152R.bool.abs__action_bar_expanded_action_views_exclusive));
                configPresenters(menuBuilder);
                actionMenuView = (ActionMenuView) this.mActionMenuPresenter.getMenuView(this);
                viewGroup2 = (ViewGroup) actionMenuView.getParent();
    ...
    public void setNavigationMode(int i) {
        ...
        if (i != i2) {
            ...
            switch (i) {
                case C0772e.WalletFragmentStyle_buyButtonWidth /*1*/:
                    if (this.mSpinner == null) {
                        this.mSpinner = new IcsSpinner(this.mContext, null, C0152R.attr.actionDropDownStyle);
                        this.mListNavLayout = (IcsLinearLayout) LayoutInflater.from(this.mContext).inflate(C0152R.layout.abs__action_bar_tab_bar_view, null);
