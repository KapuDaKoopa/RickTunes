...
public class FakeDialogPhoneWindow extends LinearLayout {
    ...
    public FakeDialogPhoneWindow(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockTheme);
        obtainStyledAttributes.getValue(C0152R.styleable.SherlockTheme_windowMinWidthMajor, this.mMinWidthMajor);
        obtainStyledAttributes.getValue(C0152R.styleable.SherlockTheme_windowMinWidthMinor, this.mMinWidthMinor);
