...
public class ActionBarContainer extends NineFrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionBar_backgroundStacked);
        ...
        if (getId() == C0152R.id.abs__split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = (ActionBarView) findViewById(C0152R.id.abs__action_bar);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && MeasureSpec.getMode(i2) == GridLayout.UNDEFINED) {
