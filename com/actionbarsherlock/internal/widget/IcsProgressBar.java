...
public class IcsProgressBar extends View {
    ...
    class SavedState extends BaseSavedState {
        ...
        final class C01781 implements Creator {
            C01781() {
            }
    ...
    public IcsProgressBar(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, ProgressBar_maxWidth);
    }
    ...
    private Drawable tileify(Drawable drawable, boolean z) {
        ...
        if (drawable instanceof LayerDrawable) {
            ...
            for (int i2 = ProgressBar_maxWidth; i2 < numberOfLayers; i2 += ProgressBar_maxHeight) {
            ...
            return z ? new ClipDrawable(layerDrawable, ProgressBar_progress, ProgressBar_maxHeight) : layerDrawable;
        }
    }
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i = ProgressBar_maxWidth; i < numberOfFrames; i += ProgressBar_maxHeight) {
            ...
            if (this.mOnlyIndeterminate && !(this.mIndeterminateDrawable instanceof AnimationDrawable)) {
                ...
                if (intrinsicWidth != f) {
                    if (f > intrinsicWidth) {
                        ...
                        i4 = (i - paddingRight) / ProgressBar_max;
                        i3 = paddingRight + i4;
                        paddingRight = paddingBottom;
                        paddingBottom = ProgressBar_maxWidth;
                    } else {
                        paddingBottom = (int) ((1.0f / intrinsicWidth) * ((float) i));
                        i4 = (i2 - paddingBottom) / ProgressBar_max;
                        i3 = paddingRight;
                        paddingRight = paddingBottom + i4;
                        paddingBottom = i4;
                        i4 = ProgressBar_maxWidth;
                    }
    ...
    protected void onVisibilityChanged(View view, int i) {
        ...
        if (i == ProgressBar_progressDrawable || i == ProgressBar_secondaryProgress) {
            stopAnimation();
        } else {
            startAnimation();
        }
    ...
    synchronized void setProgress(int i, boolean z) {
        if (!this.mIndeterminate) {
            int i2 = i < 0 ? ProgressBar_maxWidth : i;
            if (i2 > this.mMax) {
                i2 = this.mMax;
            }
