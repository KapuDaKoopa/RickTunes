...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0152R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0152R.styleable.SherlockActionMode, i, ANIMATE_IDLE);
        setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionMode_background));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionMode_titleTextStyle, ANIMATE_IDLE);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(C0152R.styleable.SherlockActionMode_subtitleTextStyle, ANIMATE_IDLE);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(C0152R.styleable.SherlockActionMode_height, ANIMATE_IDLE);
        this.mSplitBackground = obtainStyledAttributes.getDrawable(C0152R.styleable.SherlockActionMode_backgroundSplit);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0152R.layout.abs__action_bar_title_item, this);
    ...
    public void initForMode(ActionMode actionMode) {
        if (this.mClose == null) {
            this.mClose = (NineLinearLayout) LayoutInflater.from(this.mContext).inflate(C0152R.layout.abs__action_mode_close_item, this, false);
            addView(this.mClose);
        } else if (this.mClose.getParent() == null) {
            addView(this.mClose);
        }
        this.mClose.findViewById(C0152R.id.abs__action_mode_close_button).setOnClickListener(new C01681(actionMode));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (MeasureSpec.getMode(i) != 1073741824) {
            ...
            int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i4, GridLayout.UNDEFINED);
            if (this.mClose != null) {
            ...
            if (this.mCustomView != null) {
                ...
                makeMeasureSpec = layoutParams.width != -2 ? 1073741824 : GridLayout.UNDEFINED;
