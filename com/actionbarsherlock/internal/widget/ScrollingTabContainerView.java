...
public class ScrollingTabContainerView extends NineHorizontalScrollView implements OnItemSelectedListener {
    ...
    public class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    customView = new CapitalizingTextView(getContext(), null, C0152R.attr.actionBarTabTextStyle);
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0152R.styleable.SherlockActionBar, C0152R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0152R.styleable.SherlockActionBar_height, 0));
    ...
    private IcsSpinner createSpinner() {
        IcsSpinner icsSpinner = new IcsSpinner(getContext(), null, C0152R.attr.actionDropDownStyle);
    ...
    private IcsLinearLayout createTabLayout() {
        IcsLinearLayout icsLinearLayout = (IcsLinearLayout) LayoutInflater.from(getContext()).inflate(C0152R.layout.abs__action_bar_tab_bar_view, null);
    ...
    private TabView createTabView(Tab tab, boolean z) {
        TabView tabView = (TabView) this.mInflater.inflate(C0152R.layout.abs__action_bar_tab, null);
    ...
    public void animateToTab(int i) {
        ...
        this.mTabSelector = new C01801(childAt);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (childCount <= 1 || !(mode == 1073741824 || mode == GridLayout.UNDEFINED)) {
            this.mMaxTabWidth = -1;
