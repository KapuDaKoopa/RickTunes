...
/* renamed from: com.andromo.dev576782.app537736.r */
final class C0216r implements Runnable {
    final /* synthetic */ C0211m f1215a;

    private C0216r(C0211m c0211m) {
        this.f1215a = c0211m;
    }
    ...
    public final void run() {
        ...
        r9 = this;
        r8 = 1;
        r0 = r9.f1215a;	 Catch:{ FileNotFoundException -> 0x0131 }
        r0 = r0.f1197g;	 Catch:{ FileNotFoundException -> 0x0131 }
        r1 = r9.f1215a;	 Catch:{ FileNotFoundException -> 0x0131 }
        r1 = r1.f1198h;	 Catch:{ FileNotFoundException -> 0x0131 }
    ...
    L_0x0038:
        r0 = move-exception;
        com.andromo.dev576782.app537736.C0211m.f1190a;	 Catch:{ all -> 0x00c1 }
        r0 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00c1 }
        r1 = "Error reading historical recrod file: ";
        r0.<init>(r1);	 Catch:{ all -> 0x00c1 }
        r1 = r9.f1215a;	 Catch:{ all -> 0x00c1 }
        r1 = r1.f1198h;	 Catch:{ all -> 0x00c1 }
    ...
    L_0x009b:
        ...
        r7 = new com.andromo.dev576782.app537736.q;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x007b }
    ...
    L_0x00c7:
        throw r0;
    L_0x00c8:
        r1 = r9.f1215a;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x007b }
        r3 = r1.f1194d;	 Catch:{ XmlPullParserException -> 0x0038, IOException -> 0x007b }
        ...
        r0 = r9.f1215a;	 Catch:{ all -> 0x0129 }
        r5 = r0.f1196f;	 Catch:{ all -> 0x0129 }
    ...
    L_0x00e3:
        ...
        r0 = (com.andromo.dev576782.app537736.C0215q) r0;	 Catch:{ all -> 0x0129 }
    ...
    L_0x0105:
        ...
        r0 = r9.f1215a;	 Catch:{ all -> 0x0129 }
        r0.f1204n = true;	 Catch:{ all -> 0x0129 }
        r0 = r9.f1215a;	 Catch:{ all -> 0x0129 }
        r0 = r0.f1205o;	 Catch:{ all -> 0x0129 }
        r1 = new com.andromo.dev576782.app537736.s;	 Catch:{ all -> 0x0129 }
    ...
    L_0x0131:
        ...
        goto L_0x0055;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.andromo.dev576782.app537736.r.run():void");
    }
}
