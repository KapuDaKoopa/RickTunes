...
public class Picasso {
    ...
    final class C08341 extends Handler {
        C08341(Looper looper) {
            super(looper);
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    this.handler.post(new C08351(e2));
                    return;
                }
            }
        }
    ...
    public interface RequestTransformer {
        ...
        final class C08361 implements RequestTransformer {
            C08361() {
            }
    ...
    static {
        HANDLER = new C08341(Looper.getMainLooper());
        singleton = null;
    }
