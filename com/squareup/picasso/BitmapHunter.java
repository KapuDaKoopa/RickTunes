...
class BitmapHunter implements Runnable {
    ...
    final class C08251 extends ThreadLocal {
        C08251() {
        }
    ...
    final class C08262 extends RequestHandler {
        C08262() {
        }
    ...
    final class C08273 implements Runnable {
        final /* synthetic */ RuntimeException val$e;
        final /* synthetic */ Transformation val$transformation;

        C08273(Transformation transformation, RuntimeException runtimeException) {
    ...
    final class C08284 implements Runnable {
        final /* synthetic */ StringBuilder val$builder;

        C08284(StringBuilder stringBuilder) {
    ...
    final class C08295 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C08295(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    final class C08306 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C08306(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    static {
        ...
        NAME_BUILDER = new C08251();
        SEQUENCE_GENERATOR = new AtomicInteger();
        ERRORING_HANDLER = new C08262();
    }
        ...
        while (i < size) {
            ...
            try {
                ...
                if (bitmap == null) {
                    ...
                    Picasso.HANDLER.post(new C08284(append));
                    return null;
                } else if (bitmap == bitmap2 && bitmap2.isRecycled()) {
                    Picasso.HANDLER.post(new C08295(transformation2));
                    return null;
                } else if (bitmap == bitmap2 || bitmap2.isRecycled()) {
                    i++;
                    bitmap2 = bitmap;
                } else {
                    Picasso.HANDLER.post(new C08306(transformation2));
                    return null;
                }
            } catch (RuntimeException e) {
                Picasso.HANDLER.post(new C08273(transformation2, e));
                return null;
            }
        }
        return bitmap2;
