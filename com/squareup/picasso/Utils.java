...
final class Utils {
    ...
    final class C08401 extends Handler {
        C08401(Looper looper) {
            super(looper);
        }
    ...
    static void flushStackLocalLeaks(Looper looper) {
        Handler c08401 = new C08401(looper);
        c08401.sendMessageDelayed(c08401.obtainMessage(), 1000);
    }
    ...
    static boolean isWebPFile(InputStream inputStream) {
        ...
        return inputStream.read(bArr, 0, WEBP_FILE_HEADER_SIZE) == WEBP_FILE_HEADER_SIZE && WEBP_FILE_HEADER_RIFF.equals(new String(bArr, 0, 4, "US-ASCII")) && WEBP_FILE_HEADER_WEBP.equals(new String(bArr, 8, 4, "US-ASCII"));
    }
